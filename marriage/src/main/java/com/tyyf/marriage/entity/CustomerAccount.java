...
public class CustomerAccount {
    ...
    public String getRecommendPersion() {
        return recommendPersion;
    }

    public void setRecommendPersion(String recommendPersion) {
        this.recommendPersion = recommendPersion == null ? null : recommendPersion.trim();
    }
